...
`Ctrl+O`, or **File → Open audio files**, opens one or more local files without starting them automatically. The files receive a temporary **Local media** session in the first free slot starting at 4.
