...
public static class CommandPaletteSearch
{
    ...
    private static string? GetLocalShortcut(string commandId)
    {
        ...
        return commandId switch
        {
            ...
            CommandIds.ExportClip => "Ctrl+S (odtwarzacz lokalnego pliku lub zaznaczony fragment pobranego podcastu)",
            CommandIds.AppendClip => "Ctrl+D (odtwarzacz lokalnego pliku lub zaznaczony fragment pobranego podcastu)",
            ...
            CommandIds.ViewWiiMNetworkStreams => "Ctrl+O (WiiM)",
            CommandIds.ImportWiiMNetworkStreams => "Ctrl+Shift+O (WiiM)",
            CommandIds.ExportWiiMNetworkStreams => "Ctrl+E (WiiM)",
            ...
            CommandIds.RenameLibraryItem => "F2 (Biblioteka lokalna, Radio lub Podcasty i YouTube)",
            ...
            CommandIds.GoToAlbum => "strzałka w prawo, a następnie Enter (lista TIDAL)",
            CommandIds.GoToArtist => "strzałka w prawo, a następnie Enter (lista TIDAL)",
            CommandIds.PodcastDescription => "Alt+D (Podcasty i YouTube oraz Spotify)",
            ...
            CommandIds.AddPodcast => "Ctrl+N (Podcasty i YouTube)",
            CommandIds.ImportPodcastOpml => "Ctrl+O (Podcasty i YouTube)",
            CommandIds.RefreshPodcast => "F5 (Podcasty i YouTube)",
            CommandIds.RefreshPodcastLibrary => "Ctrl+F5 (Podcasty i YouTube)",
            CommandIds.ViewSpotifyPodcasts => "Ctrl+Alt+O (Spotify)",
            CommandIds.ViewPodcastInbox => "Ctrl+I",
            CommandIds.ViewPodcastInProgress => "Ctrl+Shift+I (Podcasty i YouTube)",
            ...
            CommandIds.ToggleRadioRecording => "R (odtwarzacz radia) lub Ctrl+R (lista radia)",
            ...
            CommandIds.ViewActiveRadioRecordings => "Alt+R",
