...
public static class CommandPaletteSearch
{
    ...
    private static string? GetLocalShortcut(string commandId)
    {
        ...
        return commandId switch
        {
            ...
            CommandIds.SeekBackward10 => "Left",
            CommandIds.SeekForward10 => "Right",
            CommandIds.SeekBackward60 => "Shift+Left",
            CommandIds.SeekForward60 => "Shift+Right",
            CommandIds.VolumeUp5 => "Ctrl+Up",
            CommandIds.VolumeDown5 => "Ctrl+Down",
            CommandIds.VolumeUp1 => "Ctrl+Shift+Up",
            CommandIds.VolumeDown1 => "Ctrl+Shift+Down",
            CommandIds.TrackStart => "Ctrl+Home",
            CommandIds.TrackEnd => "Ctrl+End",
            CommandIds.TimeElapsed => "Ctrl+E",
            CommandIds.TimeRemaining => "Ctrl+R",
            CommandIds.TimeTotal => "Ctrl+T",
