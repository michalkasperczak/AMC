...
public static class CommandCatalog
{
    ...
    public static string GetDisplayName(string commandId)
    {
        ...
        return commandId switch
        {
            ...
            CommandIds.ToggleLoudnessNormalization => "Przełącz normalizację głośności lokalnych utworów",
            ...
            CommandIds.SettingsLoudnessNormalization => "Ustawienia: normalizacja głośności lokalnych utworów",
