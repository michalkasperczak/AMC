...
public static class CommandCatalog
{
    ...
    public static string GetDisplayName(string commandId)
    {
        ...
        return commandId switch
        {
            ...
            CommandIds.SeekBackwardCustom => "Cofnij o ustawiony czas",
            CommandIds.SeekForwardCustom => "Przewiń o ustawiony czas",
            ...
            CommandIds.ViewWiiMNetworkStreams => "Otwórz zapisane strumienie WiiM",
            CommandIds.ImportWiiMNetworkStreams => "Importuj strumienie z playlisty do WiiM",
            CommandIds.ExportWiiMNetworkStreams => "Eksportuj strumienie do WiiM Home",
            CommandIds.ViewWiiMDevicePresets => "Presety urządzenia WiiM",
            CommandIds.PreviousWiiMDevicePreset => "Poprzedni strumień lub zajęty preset urządzenia WiiM",
            CommandIds.NextWiiMDevicePreset => "Następny strumień lub zajęty preset urządzenia WiiM",
            CommandIds.SelectWiiMInput => "Wybierz wejście urządzenia WiiM",
            CommandIds.SelectWiiMOutput => "Wybierz wyjście urządzenia WiiM",
            CommandIds.SelectWiiMEqualizer => "Wybierz ustawienie korektora WiiM",
            CommandIds.SelectWiiMRepeatMode => "Wybierz tryb powtarzania WiiM",
            CommandIds.ToggleWiiMShuffle => "Włącz lub wyłącz losowanie WiiM",
            CommandIds.SetWiiMSleepTimer => "Ustaw timer uśpienia WiiM",
            ...
            CommandIds.ViewRecordedRadioFiles => "Pokaż historię nagrywania",
            ...
            CommandIds.ViewChapters => "Pokaż rozdziały bieżącego materiału",
            CommandIds.AddNamedChapter => "Dodaj nazwany rozdział w bieżącym miejscu",
            CommandIds.PreviousChapter => "Poprzedni rozdział w bieżącym materiale",
            CommandIds.NextChapter => "Następny rozdział w bieżącym materiale",
            ...
            CommandIds.DownloadInService => "Pobierz odcinek podcastu",
