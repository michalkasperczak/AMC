...
public partial class MainWindow
{
        ...
        string slotLabel)
    {
        ...
        try
        {
            // Odczyt katalogu zwraca teraz opakowanie z adresem nastepnej strony
            // (doladowywanie utworow wykonawcy). Preset albumu potrzebuje samych
            // pozycji: album przychodzi jedna strona i nie ma wiersza "wczytaj
            // wiecej", wiec pozostale pola opakowania go nie dotycza.
            var tracks = (await LoadSpotifyContainerItemsAsync(album).ConfigureAwait(true)).Items;
