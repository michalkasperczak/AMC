...
internal static class SpotifyNativeCollectionTests
{
    internal static void Run()
    {
        ...
        var viewName = (string)cache.Invoke(window,["spotify",container,new[]{c},null,null])!;
        ...
        if ((string)cache.Invoke(window,["spotify",container,new[]{c},null,null])! != viewName)
        ...
        cache.Invoke(window,["spotify",container,new[]{c},null,null]);
