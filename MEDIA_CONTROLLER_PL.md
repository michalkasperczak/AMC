...
Przypisanie lokalnego presetu utrwala stabilne wskazanie stacji i w razie potrzeby zachowuje ją w Bibliotece radia; wyczyszczenie presetu nie usuwa stacji z Biblioteki ani Ulubionych. Presety urządzenia pozostają inną kolekcją należącą do konkretnego urządzenia i są odczytywane lub zapisywane przez jego API. Ta sama powierzchnia `Ctrl+P` może w sesji WiiM pokazać presety WiiM, a w sesji Radia — lokalne presety AMC, bez synchronizowania ich pod tą samą tożsamością.
