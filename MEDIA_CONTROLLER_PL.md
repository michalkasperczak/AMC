...
Próba techniczna BASS 2.4 na tych samych adresach potwierdziła sprawne dekodowanie starszych ICY MP3 Polskiego Radia i OGG Radia Emaus, lecz również wykazała granice: strumień niedostępny po stronie serwera nie staje się dostępny dzięki zmianie dekodera, surowy AAC może nadal wymagać właściwego kodeka, a HLS osobnego BASSHLS. BASS jest biblioteką własnościową, bezpłatną tylko dla zastosowań niekomercyjnych. Ponieważ projekt przewiduje publiczne wydania i dobrowolne wsparcie PayPal, nie wolno umieszczać jego plików binarnych w podstawowym pakiecie bez wcześniejszego potwierdzenia licencji albo zakupu właściwej licencji. Ewentualny adapter BASS pozostaje wymiennym silnikiem radiowym, a nie zależnością rdzenia sesji.
