...
Odtwarzacz odbiera i dekoduje transmisję poza wątkiem okna, a dekodowany dźwięk umieszcza w ograniczonym pierścieniowym buforze pamięci. Strzałki lewo/prawo przemieszczają się po timeshifcie, Home wybiera najstarszy nadal dostępny fragment, End wraca na żywo, a odczyty czasu rozróżniają pozycję w buforze, opóźnienie względem transmisji i długość dostępnego bufora. Bufor nie jest trwałym archiwum i znika po zatrzymaniu stacji. Zakładki, skok do procentu lub wpisanego czasu i regulacja prędkości nie są oferowane dla transmisji na żywo.
